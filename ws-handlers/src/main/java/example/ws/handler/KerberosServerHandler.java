	...
	public boolean handleMessage(SOAPMessageContext context) {
		...
		CipherClerk cc = new CipherClerk();
			...
			if (outboundElement.booleanValue()) {
				System.out.println("OUTBOUND MESSAGE NO SERVIDOR LOL RSRS");
				...
				System.out.println("NAMETICKET TOSTRING" +  nameTicket.toString());
				...
				System.out.println("VALUE STRING ESTOU FARTO " + valueString);
...
//				}
				...
				System.out.println("DEPOIS CARALHO");
				valueString = element.getValue();
				System.out.println("DEPOIS do depois CARALHO");
